<template>
            ...
            <div class="card-body">
              ...
              <form @submit.prevent="handleSubmit">
                ...
                <div class="modal-footer">
                  <button @click="BackHome" type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">
                    Close
                  </button>
  ...
  onMounted(async () => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/requests/edit/${id}`, {
        headers: {
      ...
      if (response.data.success) {
        ...
        toast.error("Failed to retrieve the request details.");
      }
    } catch (error) {
      toast.error("An error occurred while fetching the request details.");
